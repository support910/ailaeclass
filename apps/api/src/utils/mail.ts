...
// format: "5GNU Developers (via 5gnumultimedia.com)" <notify@mail.5gnumultimedia.com>
...
<body style="
    ...
    ">
  <div class="gutter">
    <a href="https://5gnumultimedia.com" target="_blank">
      <img src="https://5gnumultimedia.com/logo-512.png" alt="5GNU Logo" /></a>
  </div>
  ...
  <div class="footer" style="
    ...
    <p style="padding-top: 8px; line-height: initial">
      5GNU ${new Date().getFullYear()}. All rights reserved.<br />
