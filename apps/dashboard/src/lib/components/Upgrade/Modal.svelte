  ...
  {:else}
    <div class="flex flex-col items-center justify-center">
      <div class="relative mb-2 flex items-center rounded-[30px] border-[2px] p-[2px] lg:scale-100">
        <button
          style="background-color: {isYearlyPlan ? 'initial' : '#0E7372'}; color: {isYearlyPlan
            ? '#5e636b'
            : '#fff'}"
        ...
        <button
          style="background-color: {isYearlyPlan ? '#0E7372' : ''}; color: {isYearlyPlan
            ? '#fff'
            : '#5e636b'}"
              ...
              {#each PLANS[planName].FEATURES as features}
                <li class="flex items-center">
                  <div>
                    <Checkmark
                      size={16}
                      fill={planName === 'EARLY_ADOPTER' ? '#fff' : '#0E7372'}
                      class="mr-2 lg:mr-3"
                    />
                  </div>
                  <p class="text-sm">
