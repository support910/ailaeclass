...
<svelte:head>
  <title>{$t('reset_password.heading')} - {BRAND.name}</title>
</svelte:head>
...
>
  <div class="mt-4 w-full">
    <h3 class="dark:text-white text-xl font-semibold my-3">{$t('reset_password.heading')}</h3>
    <p class="dark:text-white text-sm mb-6">{$t('reset_password.description')}</p>
    <TextField
