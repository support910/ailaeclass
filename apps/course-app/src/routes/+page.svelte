...
<section class="my-10 w-full">
  <div class="text-center text-sm text-neutral-500 space-y-2">
    <p>
      Made with ❤️ by <a href="https://5gnumultimedia.com" target="_blank" rel="noopener noreferrer">
        5GNU
      </a>
    </p>
    ...
    <p class="text-xs text-neutral-400">
      <a href="mailto:support@5gnumultimedia.com" class="hover:underline">support@5gnumultimedia.com</a>
    </p>
  </div>
</section>
<!-- Footer End -->
