---
title: Self-hosting ailaeclass
description: Guide to self-hosting ailaeclass on your own servers.
---

import { Callout } from 'fumadocs-ui/components/callout';
import { Step, Steps } from 'fumadocs-ui/components/steps';

This guide will help you quickly self-host ailaeclass.

![Selfhost ailaeclass](/selfhost-ailaeclass.webp)

ailaeclass is made up of the following applications:

- [apps/api](https://github.com/rotimi-best/ailaeclass/tree/main/apps/api) - an Express server
- [apps/dashboard](https://github.com/rotimi-best/ailaeclass/tree/main/apps/dashboard) - the admin dashboard + LMS
- [supabase](https://github.com/rotimi-best/ailaeclass/tree/main/supabase) - the database + REST API
...
<Callout title="Learn More">
  ...
  [here](https://github.com/rotimi-best/ailaeclass/blob/main/apps/api/.env.example)
</Callout>
...
<Callout title="Learn More">
  Learn more about the environment variables
  [here](https://github.com/rotimi-best/ailaeclass/blob/main/apps/dashboard/.env.example)
</Callout>
