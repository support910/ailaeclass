      ...
      <div class="mx-auto flex max-w-lg flex-col items-center gap-2">
        ...
        <div class="text-base leading-snug text-center">
          ...
          <span class="text-gray-800" style="font-size: 17px;"
            >ailaeclass really helped me bootstrap my program. The dashboard is extremely
            intuitive. I could navigate most of it without any help / support. Coming from framer, I
            can honestly say that I am extremely greatful that I found ailaeclass.</span
...
<Section
  ...
  description="ailaeclass simplifies teaching tasks, boosts the educational experience, and is beneficial for both educators and students, providing a user-friendly platform for assessment, grading, attendance, and scorebook management."
  video="https://brand.cdn.ailaeclass.com/course-management.mp4"
  rightToLeft={true}
/>
<Section
  id="ai"
  tagline="Efficient"
  title="AI Support"
  description="Our platform integrates AI to simplify lesson outline generation, streamline lesson planning and spark creative ideas. With ailaeclass, educators can focus on what matters most: teaching."
  rightToLeft={false}
  video="https://brand.cdn.ailaeclass.com/ai-lesson.mp4"
/>
<Section
  id="customization"
  tagline="Flexible"
  title="Dashboard Customization"
  description="ailaeclass offers organizations the ability to tailor our LMS to their specific requirements. With our customizable features, you can create a personalized learning environment that aligns with your organization's goals"
  rightToLeft={true}
  video="https://brand.cdn.ailaeclass.com/lms-customization.mp4"
/>
<Section
  id="collaboration"
  ...
  video="https://brand.cdn.ailaeclass.com/community.mp4"
  rightToLeft={false}
/>
