<script lang="ts">
  ...
  async function setStars() {
    try {
      const response = await fetch('https://api.github.com/repos/ailaeclass/ailaeclass');
  ...
  <a href="/" class="w-[10%]">
    <div class="flex items-center w-full">
      <img
        ...
        class="w-6 md:w-10"
      />
      <h1 class="text-xs md:text-lg font-medium ml-2">ailaeclass</h1>
    </div>
  </a>
