...
imageUrl: 'https://assets.cdn.ailaeclass.com/blog/brand-customisations.png'
date: '2024-10-07'
author: Rotimi Best
...
![ailaeclass-brand-customisations](https://assets.cdn.ailaeclass.com/blog/brand-customisations.png)
_ailaeclass Brand Customisations_
...
Firstly let me quickly break down what we mean when we say _YOUR STUDENT DASHBOARD._ As an organisation or educator when you sign up on [ailaeclass.com](https://ailaeclass.com), you'd have to first create your organisation and then create your first course. This whole process is done within the admin dashboard - [app.ailaeclass.com](https://app.ailaeclass.com).

![ailaeclass-courses-page](https://brand.cdn.ailaeclass.com/ailaeclass-courses.png)
_The admin dashboard - app.ailaeclass.com_
...
![ailaeclass-lms-student-dashboard](https://brand.cdn.ailaeclass.com/ailaeclass-lms-courses.png)
_The LMS aka Student dashboard - yourorg.ailaeclass.com_

Typically this page can be found at *yourorg.ailaeclass.com*, where *yourorg* is a slug you set when you first set up your account. For example, we've built an internal bootcamp called ailaeclass Developers, in this bootcamp we train other developers on some of the key tools we use internally. You can checkout our page here: [ciodevs.ailaeclass.com](https://ciodevs.ailaeclass.com), in this case you can see that our slug is *ciodevs* and you should be able to easily see yours when you log into the dashboard `/org/{yourorg}`.
...
![ailaeclass-customise-brand-color](https://brand.cdn.ailaeclass.com/customise-brand-color.png)
...
Thank you very much for reading till the end, I know this was a lot 😅. Please give this update a try and let us know what you think about it on [X](https://x.com/ailaeclass).
