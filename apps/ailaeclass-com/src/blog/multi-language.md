...
imageUrl: 'https://assets.cdn.ailaeclass.com/blog/multi-language-support.png'
date: '2024-10-08'
author: Rotimi Best
...
![multi-language-support](https://assets.cdn.ailaeclass.com/blog/multi-language-support.png)
_ailaeclass now supports 8 languages_

We are happy to share that within the ailaeclass dashboard and your dedicated student dashboard we now support 8 languages including English. These 8 languages include:
...
![select-language-settings](https://assets.cdn.ailaeclass.com/blog/select-language-settings.png)
_Language selector in ailaeclass Dashboard._
...
<video class="embed mb-5" controls poster="https://assets.cdn.ailaeclass.com/blog/multi-language-support.png">
  <source src="https://assets.cdn.ailaeclass.com/blog/language-editor-demo.mov" type="video/mp4">
  Your browser does not support the video tag.
</video>

## Next steps

All translations in our app are stored in a JSON file which we generate and keep up to date using Google translate. This means that it might not be 100% accurate and there could be some mistakes when use  our dashboard in other languages. If you do find any issues with our translations, please do open an [issue on Github](https://github.com/ailaeclass/ailaeclass/issues/new/choose) with the correct translation and we'd be so happy to fix it.

If you are a native speaker of any of the 7 languages and want to contribute, please feel free to nitpick into our [translations](https://github.com/ailaeclass/ailaeclass/tree/main/apps/dashboard/src/lib/utils/translations) and open a PR with the fixes. Every contribution is valuable and will be gladly welcomed 😊