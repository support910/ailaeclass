<script lang="ts">
  ...
  const steps = [
    {
      title: 'Sign up',
      subText: 'Create a free account on our platform by going to ailaeclass.com/signup'
    },
    {
  ...
  let faqs = [
    {
      question: 'What kind of tutors does ailaeclass look for?',
      answer:
    ...
    {
      question: 'What equipment do I need to teach on ailaeclass?',
...
<svelte:head>
  <title>Teach | ailaeclass</title>
  <meta property="og:image" itemprop="image" content="https://brand.cdn.ailaeclass.com/og/teach.png" />
  <meta property="og:title" content="Teach on ailaeclass" />
  <meta
    property="og:description"
    content="On ailaeclass you can make side income while doing what you love."
  />

  <meta
    property="og:image:secure_url"
    itemprop="image"
    content="https://brand.cdn.ailaeclass.com/og/teach.png"
  />

  <meta name="twitter:title" content="Teach on ailaeclass" />
  <meta
    name="twitter:description"
    content="On ailaeclass you can make side income while doing what you love."
  />
  <meta name="twitter:image" content="https://brand.cdn.ailaeclass.com/og/teach.png" />
</svelte:head>
  ...
  <PageHeader className="flex items-center justify-evenly px-5 flex-wrap text-left">
    <div>
      ...
      <p class="my-5 lg:w-[77%] lg:text-left text-center">
        With ailaeclass, you can make side income while teaching the subject you love
      </p>
    ...
    <div class="px-2 lg:px-[12%] bg-[#F5F8FE] my-10 py-12 h-[75%] lg:h-[80%]">
      ...
      >
        <h1 class="text-base font-medium leading-5 w-[77%] mx-auto">
          With ailaeclass, I am training over 100 students. I am making more money than expected
