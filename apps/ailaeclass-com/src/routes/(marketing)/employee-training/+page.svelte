...
<svelte:head>
  <title>Employee Training | ailaeclass</title>
</svelte:head>
...
<section class="flex flex-col justify-center items-center">
    ...
    >
      ...
      >
        ...
        <p class="lg:w-[60%] text-base md:text-lg lg:text-center font-normal text-slate-700">
          With ailaeclass, you can keep your teams in sync with company standards as they change
          quickly.
        </p>
      </div>
      <a
    ...
    >
      {#each benefitDetails as benefits}
        ...
        >
          <img
            class="w-[48px] h-[48px]"
            src="https://assets.cdn.ailaeclass.com/www/employee-training/{benefits.icon}"
            alt="light-bulb"
          />
      ...
      {#each featureDetails as feature, i}
        ...
        >
          ...
          >
            <img
              class="w-[48px] h-[48px]"
              src="https://assets.cdn.ailaeclass.com/www/employee-training/{feature.icon}"
              alt="team icon"
            />
            <div class="md:w-full flex flex-col items-start justify-start gap-y-4">
          ...
          <div>
            <img
              ...
              src="https://assets.cdn.ailaeclass.com/www/employee-training/{feature.img}"
  ...
  >
    ...
    >
      ...
      <img
        class="size-96"
        src="https://assets.cdn.ailaeclass.com/www/employee-training/bro.svg"
