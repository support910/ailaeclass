...
<svelte:head>
  <title>Bootcamps | ailaeclass</title>
</svelte:head>
    ...
    >
      ...
      >
        ...
        <p class="lg:w-[60%] text-base md:text-lg lg:text-center font-normal text-slate-700">
          From AI powered course creation to student collaboration tools, ailaeclass provides
    ...
    >
      ...
      >
        ...
        <p class="text-[#334155] text-sm md:text-base font-light lg:text-center md:w-[80%]">
          Scale your bootcamp with ailaeclass's comprehensive toolkit. Create engaging content,
    ...
    >
      {#each benefitDetails as benefits}
        <div class="w-full md:p-6 p-4 border border-[#D9E0F5] rounded-2xl flex flex-col gap-y-6">
          <img
            class="w-[48px] h-[48px]"
            src="https://assets.cdn.ailaeclass.com/www/bootcamps/{benefits.icon}"
            alt="brain"
          />
          ...
          <div class="w-full flex flex-col justify-start align-start gap-y-2">
            ...
            {#each benefits.points as point}
              <div class="flex flex-row justify-start items-start gap-x-3">
                <img
                  src="https://assets.cdn.ailaeclass.com/www/bootcamps/{benefits.checkMark}"
                  alt="check mark"
                />
      ...
      {#each featureDetails as feature, i}
        ...
        >
          ...
          >
            <img
              class="w-[48px] h-[48px]"
              src="https://assets.cdn.ailaeclass.com/www/bootcamps/{feature.icon}"
              alt="team icon"
            />
          ...
          <div>
            <img
              ...
              src="https://assets.cdn.ailaeclass.com/www/bootcamps/{feature.img}"
