...
<svelte:head>
  <title>Customer Education | ailaeclass</title>
</svelte:head>
    ...
    >
      {#each benefitDetails as benefits}
        <div class="w-full md:p-6 p-4 border border-[#D9E0F5] rounded-2xl flex flex-col gap-y-6">
          <img
            class="w-[48px] h-[48px]"
            src="https://assets.cdn.ailaeclass.com/www/customer-education/{benefits.icon}"
            alt="icon"
          />
    ...
    >
      {#each featureDetails as feature, i}
        ...
        >
          ...
          >
            <img
              src="https://assets.cdn.ailaeclass.com/www/customer-education/{feature.icon}"
              alt="team icon"
            />
          ...
          <div>
            <img
              ...
              src="https://assets.cdn.ailaeclass.com/www/customer-education/{feature.img}"
