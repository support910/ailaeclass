...
<svelte:head>
  <title>Pomodoro Timer | ailaeclass</title>
  <meta property="og:image" itemprop="image" content="" />
  <meta property="og:title" content="Pomodoro Timer | ailaeclass" />
  <meta
  ...
  <meta name="twitter:title" content="Pomodoro Timer | ailaeclass" />
  <meta
