<script lang="ts">
  ...
  $: rootBgImage = `https://assets.cdn.ailaeclass.com/progress-report/backgrounds/${
  ...
  <div class="mt-20">
    ...
    >
      <div class="relative w-full h-full flex flex-col justify-center gap-3 items-center px-2">
        <!-- avatar -->
        <img
          src={`https://assets.cdn.ailaeclass.com/progress-report/avatar/${
    ...
    >
      <img src="/logo-192.png" alt="ailaeclass logo" class="w-4" />
      <p class="text-[10px] font-bold">ailaeclass.com</p>
    </div>
    <!--  -->
  </div>
</div>
