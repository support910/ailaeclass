<script lang="ts">
  ...
  function shareOnFacebook() {
    const text = shareTemplate();
    window.open(
      `https://www.facebook.com/dialog/share?app_id=145634995501895&display=popup&href=https%3A%2F%2Failaeclass.com%2Fdocs%2F&redirect_uri=https%3A%2F%2Failaeclass.com%2Ftools%2Fexplorer&hashtag=${text}`
    );
  }
...
<svelte:head>
  <title>Random Name Picker | ailaeclass</title>
  <meta
    property="og:image"
    itemprop="image"
    content="https://brand.cdn.ailaeclass.com/og/free-tools.png"
  />
  <meta property="og:title" content="Random Name Picker | ailaeclass" />
  <meta
  ...
  <meta name="twitter:title" content="Random Name Picker | ailaeclass" />
  <meta
    name="twitter:description"
    content="Use this online name picker to draw a random name from a list of names for your online or physical classroom."
  />
  <meta name="twitter:image" content="https://brand.cdn.ailaeclass.com/og/free-tools.png" />
</svelte:head>
      ...
      >
              ...
              >
                {#if $htmlBody.mood.text}
                  <span class="flex gap-1 items-center">
                    ...
                    <img
                      src="https://assets.cdn.ailaeclass.com/progress-report/emojis/{$htmlBody.mood
                        .iconSrc}.png"
        ...
        <div class="flex flex-wrap justify-between items-center mt-3">
          <div class="w-full md:w-2/4">
            ...
            >
              <img
                src={`https://assets.cdn.ailaeclass.com/progress-report/avatars/${
          ...
          <div class="w-full md:w-2/4">
            ...
            >
              <img
                src={`https://assets.cdn.ailaeclass.com/progress-report/backgrounds/${
