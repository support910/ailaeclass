<script lang="ts">
  ...
  onMount(() => {
    buzzSound = new Audio('https://assets.cdn.ailaeclass.com/beeping-sound.mp3');
  });
</script>

<svelte:head>
  <title>Activity Stopwatch | ailaeclass</title>
  <meta
    property="og:image"
    itemprop="image"
    content="https://brand.cdn.ailaeclass.com/og/free-tools.png"
  />
  <meta property="og:title" content="Activity Stopwatch | ailaeclass" />
  <meta
  ...
  <meta name="twitter:title" content="Activity Stopwatch | ailaeclass" />
  <meta
